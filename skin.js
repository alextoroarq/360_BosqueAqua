...
// Filename: Crystal_Suite.ggsk
// Generated 2024-07-19T16:40:00
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el=me._carpeta_plano=document.createElement('div');
		el.ggId="Carpeta Plano";
		...
		me._carpeta_plano.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._carpeta_plano.ggUpdatePosition=function (useTransition) {
		}
		el=me._planoapto=document.createElement('div');
		el.ggFilter = '';
		el.ggFilteredIds = [];
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='100% 0%';
		me._planoapto.ggIsActive=function() {
		...
		me._planoapto.ggUpdateConditionResize=function () {
			var mapDetails = player.getMapDetails(me._planoapto.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._planoapto.ggCalculateFloorplanSize(mapDetails);
			me._planoapto.ggShowSimpleFloorplan(mapDetails);
			me._planoapto.ggPlaceMarkersOnSimpleFloorplan();
			me._planoapto.ggRadar.update();
		}
		me._planoapto.ggUpdateConditionTimer=function () {
			me._planoapto.ggRadar.update();
		}
		me._planoapto.ggUpdatePosition=function (useTransition) {
			me._planoapto.ggUpdateConditionResize();
		}
		me._planoapto.ggNodeChange=function () {
			var mapDetails = player.getMapDetails(me._planoapto.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._planoapto.ggCalculateFloorplanSize(mapDetails);
			me._planoapto.ggShowSimpleFloorplan(mapDetails);
			me._planoapto.ggPlaceMarkersOnSimpleFloorplan();
			me._planoapto.ggRadar.update();
			if (me._planoapto.ggLastNodeId) {
				var lastActiveMarker = me._planoapto.ggSimpleFloorplanMarkerArray[me._planoapto.ggLastNodeId];
				if (lastActiveMarker && lastActiveMarker.ggDeactivate) lastActiveMarker.ggDeactivate();
			}
			var id = player.getCurrentNode();
			var marker = me._planoapto.ggSimpleFloorplanMarkerArray[id];
			if (marker) {
				if (marker.ggActivate) marker.ggActivate();
			}
			me._planoapto.ggLastNodeId = id;
		}
		me._carpeta_plano.appendChild(me._planoapto);
		me.divSkin.appendChild(me._carpeta_plano);
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			...
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		me._button_open_map.onclick=function (e) {
			me._carpeta_plano.ggVisible = !me._carpeta_plano.ggVisible;
			var flag=me._carpeta_plano.ggVisible;
			me._carpeta_plano.style[domTransition]='none';
			me._carpeta_plano.style.visibility=((flag)&&(Number(me._carpeta_plano.style.opacity)>0||!me._carpeta_plano.style.opacity))?'inherit':'hidden';
		}
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			''+
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			''+
			''+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._planoapto.ggMarkerInstances=[];
		me._planoapto.ggMapId = 'PlanoApto';
		me._planoapto.ggLastNodeId=null;
		me._planoapto.callChildLogicBlocksHotspot_map_pin_changenode = function(){
			if(me._planoapto.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._planoapto.ggMarkerInstances.length; i++) {
					if (me._planoapto.ggMarkerInstances[i]._map_pin_tt && me._planoapto.ggMarkerInstances[i]._map_pin_tt.logicBlock_alpha) {
						me._planoapto.ggMarkerInstances[i]._map_pin_tt.logicBlock_alpha();
					}
				}
			}
		}
		me._planoapto.callChildLogicBlocksHotspot_map_pin_configloaded = function(){
			if(me._planoapto.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._planoapto.ggMarkerInstances.length; i++) {
					if (me._planoapto.ggMarkerInstances[i]._map_pin_tt && me._planoapto.ggMarkerInstances[i]._map_pin_tt.logicBlock_position) {
						me._planoapto.ggMarkerInstances[i]._map_pin_tt.logicBlock_position();
					}
				}
			}
		}
		me._planoapto.callChildLogicBlocksHotspot_map_pin_mouseover = function(){
			if(me._planoapto.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._planoapto.ggMarkerInstances.length; i++) {
					if (me._planoapto.ggMarkerInstances[i]._map_pin_active && me._planoapto.ggMarkerInstances[i]._map_pin_active.logicBlock_scaling) {
						me._planoapto.ggMarkerInstances[i]._map_pin_active.logicBlock_scaling();
					}
					if (me._planoapto.ggMarkerInstances[i]._map_pin_normal && me._planoapto.ggMarkerInstances[i]._map_pin_normal.logicBlock_scaling) {
						me._planoapto.ggMarkerInstances[i]._map_pin_normal.logicBlock_scaling();
					}
				}
			}
		}
		...
		me._planoapto.callChildLogicBlocksHotspot_map_pin_active = function(){
			if(me._planoapto.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._planoapto.ggMarkerInstances.length; i++) {
					if (me._planoapto.ggMarkerInstances[i]._map_pin_active && me._planoapto.ggMarkerInstances[i]._map_pin_active.logicBlock_alpha) {
						me._planoapto.ggMarkerInstances[i]._map_pin_active.logicBlock_alpha();
					}
					if (me._planoapto.ggMarkerInstances[i]._map_pin_normal && me._planoapto.ggMarkerInstances[i]._map_pin_normal.logicBlock_alpha) {
						me._planoapto.ggMarkerInstances[i]._map_pin_normal.logicBlock_alpha();
					}
				}
			}
		}
		me._planoapto.callChildLogicBlocksHotspot_map_pin_hastouch = function(){
			if(me._planoapto.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._planoapto.ggMarkerInstances.length; i++) {
					if (me._planoapto.ggMarkerInstances[i]._map_pin_tt && me._planoapto.ggMarkerInstances[i]._map_pin_tt.logicBlock_position) {
		...
		me._planoapto.callChildLogicBlocksHotspot_map_pin_activehotspotchanged = function(){
			if(me._planoapto.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._planoapto.ggMarkerInstances.length; i++) {
					if (me._planoapto.ggMarkerInstances[i]._map_pin_tt && me._planoapto.ggMarkerInstances[i]._map_pin_tt.logicBlock_alpha) {
		...
		me._planoapto.ggSimpleFloorplanMarkerArray=[];
		me._planoapto.ggFloorplanWidth=0;
		me._planoapto.ggFloorplanHeight=0;
		me._planoapto__mapdiv=document.createElement('div');
		me._planoapto__mapdiv.className='ggskin ggskin_map';
		me._planoapto.appendChild(me._planoapto__mapdiv);
		me._planoapto__img=document.createElement('img');
		me._planoapto__img.className='ggskin ggskin_map';
		me._planoapto__mapdiv.appendChild(me._planoapto__img);
		me._planoapto.ggRadar={ lastFov : -1, lastPan : -1, xPos : -1, yPos : -1, radarElement : null }
		me._planoapto.ggRadar.update=function() {
			var radar=me._planoapto.ggRadar;
			var d2r = Math.PI/180 ;
			var fov = player.getFov();
			var pan = player.getPanNorth();
			pan -= me._planoapto.ggFloorplanNorth;
			var filterpassed = true;
			var currentId = player.getCurrentNode();
			if (me._planoapto.ggFilteredIds.length > 0 && me._planoapto.ggFilteredIds.indexOf(currentId) == -1) filterpassed = false;
			if ((me._planoapto.ggSimpleFloorplanMarkerArray.hasOwnProperty(currentId)) && filterpassed) {
				var activeMarker = me._planoapto.ggSimpleFloorplanMarkerArray[currentId];
				if ((radar.radarElement) && (fov==radar.lastFov) && (pan==radar.lastPan) && (activeMarker.radarXPos==radar.xPos) && (activeMarker.radarYPos==radar.yPos)) return; 
				radar.lastPan=pan; radar.lastFov=fov;
				radar.xPos=activeMarker.radarXPos; radar.yPos=activeMarker.radarYPos;
				if (radar.radarElement) me._planoapto__mapdiv.removeChild(radar.radarElement);
				...
				radarPath.setAttributeNS(null,'fill', '#d92d4c');
				radarPath.setAttributeNS(null,'fill-opacity', 0.35);
				radarPath.setAttributeNS(null,'stroke', '#d92d4c');
				radarPath.setAttributeNS(null,'stroke-opacity', 0.8);
				radarPath.setAttributeNS(null,'stroke-width', 1);
				radarPath.setAttributeNS(null,'stroke-linejoin', 'miter');
				radar.radarElement.appendChild(radarPath);
				me._planoapto__mapdiv.appendChild(radar.radarElement);
				var radarXPos = activeMarker.radarXPos - 50;
				var radarYPos = activeMarker.radarYPos - 50;
				radar.radarElement.style['position'] = 'absolute';
				radar.radarElement.style['left'] = '' + radarXPos + 'px';
				radar.radarElement.style['top'] = '' + radarYPos + 'px';
				radar.radarElement.style['z-index'] = me._planoapto.style['z-index'] + 1;
			} else {
				if (radar.radarElement) {
					me._planoapto__mapdiv.removeChild(radar.radarElement);
					radar.radarElement = null;
				}
			}
		}
		me._planoapto.ggShowSimpleFloorplan=function(mapDetails) {
			var mapWidth = me._planoapto.clientWidth;
			var mapHeight = me._planoapto.clientHeight;
			...
			var imageFilename = basePath + 'images/maptiles/' + me._planoapto.ggMapId + '_' + level + '.' + mapDetails['tileformat'];
			me._planoapto__img.setAttribute('src', imageFilename);
		me._planoapto__mapdiv.setAttribute('style','position: absolute; right: 0px; top: 0px;width:' + me._planoapto.ggFloorplanWidth + 'px;height:' + me._planoapto.ggFloorplanHeight + 'px;overflow:hidden;;');
		me._planoapto__img.setAttribute('style','width:' + me._planoapto.ggFloorplanWidth + 'px;height:' + me._planoapto.ggFloorplanHeight + 'px;-webkit-user-drag:none;pointer-events:none;');
		}
		me._planoapto.ggCalculateFloorplanSize=function(mapDetails) {
			var floorplanWidth = mapDetails['width'];
			var floorplanHeight = mapDetails['height'];
			var frameAR = me._planoapto.clientWidth / me._planoapto.clientHeight;
			var floorplanAR = floorplanWidth / floorplanHeight;
			if (frameAR > floorplanAR) {
				me._planoapto.ggFloorplanHeight = me._planoapto.clientHeight;
				me._planoapto.ggFloorplanWidth = me._planoapto.ggFloorplanHeight * floorplanAR;
			} else {
				me._planoapto.ggFloorplanWidth = me._planoapto.clientWidth;
				me._planoapto.ggFloorplanHeight = me._planoapto.ggFloorplanWidth / floorplanAR;
			}
		}
		me._planoapto.ggInitMap=function() {
			me._planoapto.ggMapNotLoaded = false;
			var mapDetails = player.getMapDetails(me._planoapto.ggMapId);
			me._planoapto.style.backgroundColor = mapDetails['bgcolor'];
			if (mapDetails.hasOwnProperty('transparent') && mapDetails['transparent']) {
				me._planoapto.ggPermeableMap = true;
			} else {
				me._planoapto.ggPermeableMap = false;
			}
			me._planoapto.ggCalculateFloorplanSize(mapDetails);
			me._planoapto.ggShowSimpleFloorplan(mapDetails);
			me._planoapto.ggFloorplanNorth = mapDetails['floorplannorth'];
		}
		me._planoapto.ggClearMap=function() {
			me._planoapto.ggClearMapMarkers();
			me._planoapto.ggMapNotLoaded = true;
		}
		me._planoapto.ggChangeMap=function(mapId) {
			var newMapType = player.getMapType(mapId)
			if (newMapType == 'web') {
				return;
			}
			me._planoapto.ggMapId = mapId;
			if (!me._planoapto.ggMapNotLoaded) {
				me._planoapto.ggClearMap();
				me._planoapto.ggInitMap();
				me._planoapto.ggInitMapMarkers();
			}
		}
		me._planoapto.ggPlaceMarkersOnSimpleFloorplan=function() {
			var markers=me._planoapto.ggSimpleFloorplanMarkerArray;
			for (id in markers) {
				if (markers.hasOwnProperty(id)) {
					marker=markers[id];
					var coords = player.getNodeMapCoordsInPercent(id, me._planoapto.ggMapId);
					var xPos = (me._planoapto.ggFloorplanWidth * coords[0]) / 100.0;
					var yPos = (me._planoapto.ggFloorplanHeight * coords[1]) / 100.0;
					marker.radarXPos = xPos;
					marker.radarYPos = yPos;
					xPos -= me._planoapto.ggHMarkerAnchorOffset;
					yPos -= me._planoapto.ggVMarkerAnchorOffset;
					marker.style['position'] = 'absolute';
					marker.style['left'] = xPos + 'px';
					marker.style['top'] = yPos + 'px';
					marker.style['z-index'] = me._planoapto.style['z-index'] + 2;
				}
			}
		}
		me._planoapto.ggInitMapMarkers=function() {
			me._planoapto.ggClearMapMarkers();
			var ids=player.getNodeIds();
			me._planoapto.ggFilteredIds = [];
			if (me._planoapto.ggFilter != '') {
				var filter = me._planoapto.ggFilter.split(',');
				for (i=0; i < ids.length; i++) {
					var nodeId = ids[i];
					var nodeData = player.getNodeUserdata(nodeId);
					for (var j=0; j < filter.length; j++) {
						if (nodeData['tags'].indexOf(filter[j].trim()) != -1) me._planoapto.ggFilteredIds.push(nodeId);
					}
				}
				if (me._planoapto.ggFilteredIds.length > 0) ids = me._planoapto.ggFilteredIds;
			}
			for(var i=0; i < ids.length; i++) {
				var id = ids[i];
				var coords = player.getNodeMapCoordsInPercent(id, me._planoapto.ggMapId);
				if (coords.length>=2) {
					me._planoapto.ggHMarkerAnchorOffset = 12;
					me._planoapto.ggVMarkerAnchorOffset = 41;
					var markerParent = new Object();
					markerParent.ggElementNodeId=function() { return id };
					var markerClass = new SkinElement_map_pin_Class(me, markerParent);
					me._planoapto.ggMarkerInstances.push(markerClass);
					var marker = markerClass._map_pin;
					me._planoapto.ggSimpleFloorplanMarkerArray[id] = marker;
					me._planoapto__mapdiv.appendChild(marker);
				}
			}
			me._planoapto.ggPlaceMarkersOnSimpleFloorplan();
			skin.updateSize(me._planoapto);
		me._planoapto.callChildLogicBlocksHotspot_map_pin_changenode();
		me._planoapto.callChildLogicBlocksHotspot_map_pin_configloaded();
		me._planoapto.callChildLogicBlocksHotspot_map_pin_mouseover();
		me._planoapto.callChildLogicBlocksHotspot_map_pin_mouseover();
		me._planoapto.callChildLogicBlocksHotspot_map_pin_active();
		me._planoapto.callChildLogicBlocksHotspot_map_pin_hastouch();
		me._planoapto.callChildLogicBlocksHotspot_map_pin_activehotspotchanged();
		}
		me._planoapto.ggClearMapMarkers=function() {
			for (id in me._planoapto.ggSimpleFloorplanMarkerArray) {
				if (me._planoapto.ggSimpleFloorplanMarkerArray.hasOwnProperty(id)) {
					me._planoapto__mapdiv.removeChild(me._planoapto.ggSimpleFloorplanMarkerArray[id]);
				}
			}
			me._planoapto.ggMarkerInstances=[];
			me._planoapto.ggSimpleFloorplanMarkerArray=[];
		...
		player.addListener('configloaded', function() {
			me._planoapto.ggClearMap();
			me._planoapto.ggInitMap(false);
			me._planoapto.ggInitMapMarkers(true);
			me._thumbnail_cloner.ggUpdate();
		});
	...
	me.callChildLogicBlocksHotspot_ht_node_changenode = function(){
		if(hotspotTemplates['ht_node']) {
			...
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (hotspotTemplates['ht_node'][i]._image_1 && hotspotTemplates['ht_node'][i]._image_1.logicBlock_visible) {
					hotspotTemplates['ht_node'][i]._image_1.logicBlock_visible();
				}
			}
		}
	}
	...
	me.skinTimerEvent=function() {
		...
		me._planoapto.ggUpdateConditionTimer();
		var hs='';
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs='data:image/png;base64,'+
			'x7Qi4Fc59z4G0QuNsTEu17g7r+r/OkKeN37ZbxHwOPL6aMb6pdey1ONDIuKaqP7FCFN9U19bxF91tKz5t2qML/pZ/Mf7zo+3TR1KLDNvb4C+p2T8A7dbnq2XRbeWD728pEvZ/2/eGX2XzvGgA3KdrBiOLedZqiFO0D28BL4AXwo87kF+ISubu2MRg0AAAAAElFTkSuQmCC';
	...
	function SkinElement_map_pin_Class(parentScope,ggParent) {
		...
		me._map_pin.onclick=function (e) {
			...
			||
				...
				player.setVariableValue('vis_map_4', false);
			}
		}
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
			''+
			''+
			...
			''+
			...
			''+
	...
	player.addListener('changenode', function(args) { me._planoapto.callChildLogicBlocksHotspot_map_pin_changenode(); });
	player.addListener('configloaded', function(args) { me._planoapto.callChildLogicBlocksHotspot_map_pin_configloaded(); });
	player.addListener('mouseover', function(args) { me._planoapto.callChildLogicBlocksHotspot_map_pin_mouseover(); });
	player.addListener('mouseover', function(args) { me._planoapto.callChildLogicBlocksHotspot_map_pin_mouseover(); });
	player.addListener('changenode', function(args) { me._planoapto.callChildLogicBlocksHotspot_map_pin_active(); });
	player.addListener('hastouch', function(args) { me._planoapto.callChildLogicBlocksHotspot_map_pin_hastouch(); });
	player.addListener('activehotspotchanged', function(args) { me._planoapto.callChildLogicBlocksHotspot_map_pin_activehotspotchanged(); });
